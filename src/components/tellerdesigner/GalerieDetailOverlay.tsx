...
export default function GalerieDetailOverlay({ design, onClose }: { design: TellerDesignRow; onClose: () => void }) {
  ...
  return (
    <>
      {/* Als Geschwister AUSSERHALB des "fixed"-Wrappers unten rendern, nicht
       * als dessen Kind: .print-only positioniert sich im Druck per
       * position:absolute gegen den naechsten positionierten Vorfahren, und
       * "fixed" zaehlt dafuer genauso wie "absolute"/"relative". Als Kind des
       * fixed-Wrappers verankerte sich der Inhalt (allen voran das Bild, das
       * erste Kind im DOM) auf jeder gedruckten Seite neu, weil fixed-
       * Elemente sich laut Spec pro Druckseite neu verankern -- das Bild
       * erschien dadurch auch auf Seite 2 mitten im Techniken-Text. */}
