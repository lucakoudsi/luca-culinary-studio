...
export const TEXT_QUOTA_BY_TIER: Record<number, number> = {
  ...
  2: 150, // Basic
  3: 375, // Pro
  4: 900, // Team (aktuell pro Nutzer, nicht geteilt -- siehe die offene Team-Frage in abo-konzept.md Abschnitt 10)
};
...
export const TEXT_QUOTA_WEIGHTS = {
  ...
  menuGangAnpassen: 2, // /api/menus/[id]/gang-anpassen -- ein Gang, kein ganzes
                      // Menue, gleiche Kostenklasse wie sousChefText/kalorien.
