...
const projekte = [
  { name: 'Frühlingsmenü 2026', beschreibung: 'Siebengängiges Menü für das Pop-up-Dinner im April.', farbe: '#7CB87A', status: 'Aktiv', recipe_ids: [], menus: [], notizen: [], created_at: '2026-03-01' },
  { name: 'Fermentations-Kollektion', beschreibung: 'Entwicklung einer Serie von 5 Gerichten basierend auf hausgemachten Fermenten.', farbe: '#C9A84C', status: 'Aktiv', recipe_ids: [], menus: [], notizen: [], created_at: '2026-04-10' },
  { name: 'Kochbuch Kapitel 3', beschreibung: 'Rezepte und Konzepte für das Kapitel „Sommer am Meer".', farbe: '#7BB8D4', status: 'Pausiert', recipe_ids: [], menus: [], notizen: [], created_at: '2026-02-01' },
];
