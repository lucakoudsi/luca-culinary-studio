    ...
    <div className="min-h-screen px-6 py-16" style={{ background: 'var(--bg)' }}>
      <div className="max-w-[640px] mx-auto">
        ...
        <div style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: 1.8 }}>
          <p>Hier stehen künftig u. a.: Vertragsgegenstand, Abo-Laufzeiten und
            Kündigungsfristen, Zahlungsbedingungen, Nutzungsrechte an
            hochgeladenen/generierten Inhalten, Haftungsbeschränkungen sowie
            das Widerrufsrecht bei digitalen Dienstleistungen.</p>
        </div>
      </div>
    </div>
  );
